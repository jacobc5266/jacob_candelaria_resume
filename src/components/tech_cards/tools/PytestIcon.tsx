...
type PytestIconProps = React.SVGProps<SVGSVGElement>

export function PytestIcon(props: PytestIconProps) {
    return (
        ...
        <svg
            ...
            {...props}
        >
            <path d="M31.512 30.398h61.304a3.006 3.006 0 010 6.012H31.512a3.007 3.007 0 01-3.004-3.004 3.008 3.008 0 013.004-3.008zm0 0" fill="#696969"></path>
